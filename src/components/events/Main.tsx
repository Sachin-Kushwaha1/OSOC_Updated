          ...
          <ProjectSlider
            slides={[
              ...
              },
              {
                ...
                title: "Smart Helmet",
                description:
                  "Smart Helmet is a smart device which will be used to send SOS messages in case of bike accidents.It will take readings of the impact on the helmet at the time of accident.Will trigger an SMS to emergency contacts and nearby hospitals.",
